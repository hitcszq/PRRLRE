...
def init():
    ...
    print match_num
    print len(train_sen),len(train_ans),len(train_tup) 
    train_x = []
    train_y = []
    train_en=[]
    ...
    print np.shape(train_x),np.shape(train_y),np.shape(train_en),match_num
...
def getsmall():
    ...
    np.save('../data/train_robot_word.npy',new_word)
    np.save('../data/train_robot_pos1.npy',new_pos1)
    np.save('../data/train_robot_pos2.npy',new_pos2)
    np.save('../data/train_robot_y.npy',new_y)
    np.save('../data/train_robot_ind.npy',new_ind)
    np.save('../data/train_robot_entity.npy',new_re)
